...
def build_transform(rescale_size=512, crop_size=448):
    ...
    cifar_test_aug_transform = torchvision.transforms.Compose([
        torchvision.transforms.RandomHorizontalFlip(),
    ...
    return {'train': train_transform, 'test': test_transform, 'train_strong_aug': train_transform_strong_aug,
            ...
            'cifar_train': cifar_train_transform, 'cifar_test': cifar_test_transform, 'cifar_test_aug':cifar_test_aug_transform, 'cifar_train_strong_aug': cifar_train_transform_strong_aug}
